const defaultColor = localStorage.getItem("customDrawDefaultColor") || "#2165D1";
...
const customActiveStyles = [
  ...
  const customDrawStyles = (defaultStyle, useCustomActive=false, customStyles=[]) => useCustomActive?[...customStyles, ...customActiveStyles, ...defaultStyle]:defaultStyle;
